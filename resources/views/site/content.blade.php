...
@if(isset($portfolios) && is_object($portfolios))
  ...
  <div class="portfolio"> 
	...
	@foreach($portfolios as $item)
	 <!-- Portfolio Item -->
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  {{$item->filter}} appleIOS isotope-item">
